...
class ATServer(Node):
    def __init__(
        ...
        *,
        ...
        self.smoothed_round_trip_time = float(self.retransmit_timeout)
        self.smoothed_variance = float(max(1, self.retransmit_timeout // 2))
    ...
    def retransmit_timer(self, seq_num: int):
        ...
        print(f"Retransmitting seq {seq_num} at time {self._network_time()} with RTO {self.retransmit_timeout}")
